...
const appViews = [
  ...
  path.join(__dirname, 'app/views/apps/all-staff-amender/edit/templating/elements/')
];
...
const sessionName = `cip-nightsapps-prototype-${(Buffer.from(config.serviceName, 'utf8')).toString('hex')}`;
