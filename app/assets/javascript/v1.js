...
function showCorrections() {
    window.location.href = '/v1/apps/50k/check/corrections?check=' + checkNumber + '&total=' + totalChecks + '&part=' + currentPart;
}
...
function redirectToCheck() {
    if (currentPart === '2' || currentPart == '3') {
        window.location.href = '/v1/apps/50k/check/checkpart2-3?check=' + checkNumber + '&total=' + totalChecks + '&part=' + currentPart;
    } else {
        window.location.href = '/v1/apps/50k/check?check=' + checkNumber + '&total=' + totalChecks + '&part=' + currentPart;
    }
}
...
function showEPSCorrections() {
    window.location.href = '/v1/apps/50k/check/eps/corrections?check=' + checkNumber + '&total=' + totalChecks + '&part=' + currentPart;
}
...
function redirectToEPS() {
    if (currentPart === '2' || currentPart === '3') {
        window.location.href = '/v1/apps/50k/check/eps/checkpart2-3?check=' + checkNumber + '&total=' + totalChecks + '&part=' + currentPart;
    } else {
        window.location.href = '/v1/apps/50k/check/eps?check=' + checkNumber + '&total=' + totalChecks + '&part=' + currentPart;
    }
}
...
function nextCheck() {
    if (checkNumber && totalChecks) {
        if (currentPart === '2' || currentPart === '3') {
            window.location.href = '/v1/apps/50k/check/checkpart2-3?check=' + (Number(checkNumber)+1) + '&total=' + totalChecks + '&part=' + currentPart;
        } else {
            window.location.href = '/v1/apps/50k/check?check=' + (Number(checkNumber)+1) + '&total=' + totalChecks + '&part=' + currentPart;
        }
    }
}
...
function nextEPS() {
    if (checkNumber && totalChecks) {
        if (currentPart === '2' || currentPart === '3') {
            window.location.href = '/v1/apps/50k/check/eps/checkpart2-3?check=' + (Number(checkNumber)+1) + '&total=' + totalChecks + '&part=' + currentPart;
        } else {
            window.location.href = '/v1/apps/50k/check/eps?check=' + (Number(checkNumber)+1) + '&total=' + totalChecks + '&part=' + currentPart;
        }
    }
}
